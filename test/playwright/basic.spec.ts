...
test("should display the airdrop form when connected, otherwise, not", async ({ page, context, metamaskPage, extensionId }) => {
  // check we see "please connect your wallet" when not connected
  await page.goto('/');
